...
static void ws_cfg_network_size_config_set_small(ws_cfg_nw_size_t *cfg)
{
    ...
    cfg->sec_prot.initial_key_min = DEFAULT_INITIAL_KEY_TIMER_MIN;
    cfg->sec_prot.initial_key_max = DEFAULT_INITIAL_KEY_TIMER_MAX;
...
int8_t ws_cfg_sec_timer_default_set(ws_sec_timer_cfg_t *cfg)
{
...
int8_t ws_cfg_sec_prot_default_set(ws_sec_prot_cfg_t *cfg)
{
    ...
    cfg->initial_key_min = DEFAULT_INITIAL_KEY_TIMER_MIN;
    cfg->initial_key_max = DEFAULT_INITIAL_KEY_TIMER_MAX;
...
int8_t ws_cfg_sec_prot_validate(ws_sec_prot_cfg_t *cfg, ws_sec_prot_cfg_t *new_cfg)
{
    ...
    if (cfg->sec_prot_trickle_imin != new_cfg->sec_prot_trickle_imin ||
            ...
            cfg->initial_key_imin != new_cfg->initial_key_imin ||
            cfg->initial_key_imax != new_cfg->initial_key_imax ||
            cfg->initial_key_min != new_cfg->initial_key_min ||
            cfg->initial_key_max != new_cfg->initial_key_max ||

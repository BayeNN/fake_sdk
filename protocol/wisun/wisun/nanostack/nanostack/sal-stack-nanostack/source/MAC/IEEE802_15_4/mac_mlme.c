...
int8_t mac_mlme_set_req(protocol_interface_rf_mac_setup_s *rf_mac_setup, const mlme_set_t *set_req)
{
    ...
    mac_api_t *mac_api;
    phy_rf_channel_configuration_s *config_params;
    uint8_t *pu8 = NULL;
    switch (set_req->attr) {
        ...
        case macSetDataWhitening:
            ...
            tr_debug("%s data whitening",  (bool) *pu8 == (bool) true ? "Enable" : "Disable");
            return 0;
        ...
        case macRfConfiguration:
            ...
            config_params = (phy_rf_channel_configuration_s *)set_req->value_pointer;

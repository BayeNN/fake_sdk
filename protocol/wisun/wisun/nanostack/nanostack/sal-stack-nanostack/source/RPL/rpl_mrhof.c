...
static void rpl_mrhof_parent_selection(rpl_instance_t *instance)
{
    ...
    more_successors = rpl_policy_mrhof_parent_set_size(instance->domain) - 1;
    last_cost = rpl_mrhof_path_cost_through_neighbour(pref_parent);
    max_rank = rpl_mrhof_max_stretched_rank(pref_parent->dodag_version, rank);

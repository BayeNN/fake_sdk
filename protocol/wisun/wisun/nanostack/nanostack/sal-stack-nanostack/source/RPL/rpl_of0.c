...
static void rpl_of0_parent_selection(rpl_instance_t *instance)
{
     ...
     */
    more_successors = rpl_policy_of0_max_backup_successors(instance->domain);
    last_cost = rank;
    max_stretched_rank = rpl_of0_max_stretched_rank(pref_parent);
    while (backup) {

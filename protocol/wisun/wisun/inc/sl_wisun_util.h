 ...
 * @brief Wi-SUN tools
 * @version $Id: b68000b5d44c95b7615074c29cb738240c6a0c99 $ $Format:%ci$ ($Format:%h$)
 *******************************************************************************
 * # License
...
/**************************************************************************//**
 * @brief Get frequency band settings from RAIL config.
 ...
 * @details Wi-SUN frequency band settings are deduced from RAIL config.

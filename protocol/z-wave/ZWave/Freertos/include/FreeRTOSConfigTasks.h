...
#define TASK_STACK_SIZE_MINIMUM                 ( ( unsigned short ) 256 )  // The minimum allowed stack size. Do not reduce!
...
#define TASK_PRIORITY_Z_WAVE_STACK              ( TASK_PRIORITY_MAX - 1 )  ///< High, due to time critical protocol activity.
...
#define TASK_PRIORITY_HIGHEST                   ( TASK_PRIORITY_MAX - 2 )  ///< High priority UserTask (Good for interrupt handling)
#define TASK_PRIORITY_NORMAL                    ( TASK_PRIORITY_MAX - 3 )  ///< Good for applications. (Used by the main User-Task!)
#define TASK_PRIORITY_BACKGROUND                ( TASK_PRIORITY_MAX - 4 )  ///< Must be 1 priority higher than idle task!

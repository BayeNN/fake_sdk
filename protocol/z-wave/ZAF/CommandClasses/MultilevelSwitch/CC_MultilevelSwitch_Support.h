...
typedef struct cc_multilevel_switch_t cc_multilevel_switch_t; // Forward declaration

typedef void (*cc_multilevel_switch_callback_t)(cc_multilevel_switch_t * p_switch);

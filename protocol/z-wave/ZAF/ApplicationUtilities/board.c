 ...
 */
#ifndef EFR32ZG23 // FIXME - OCELOT_HARDCODED
 ...
 */
static GPIO_Port_TypeDef Board_GetButtonIntNo(button_id_t btn)
{
  return (Board_IsButtonAvailable_WithAssert(btn)) ? m_button_info[btn].int_no : 1;
}
...
#ifdef EFR32ZG23 // OCELOT_HARDCODED - this has not been tested! to be tested once SensorPIR is available!
...
#ifndef EFR32ZG23 // FIXME - OCELOT_HARDCODED - Rgb leds have not been ported to Ocelot yet
  uint32_t on_value = Board_GetLedOnValue(led);

...
#define DEBUGPRINT  // Must remain defined.
...
/**
 * TODO uncomment the section below, once sl_simple_rgbw_pwm_led.c can be build
 * for series2.
...
//  sl_led_set_rgbw_color(&m_sl_led, 100, 100, 100, 0);
  ...
  // TODO turn on LEDs on the WSTK board.
}
...
void HMIChecker_buttonEventHandler(BUTTON_EVENT btnEvent)
{
  ...
  {
    DPRINTF("    HMI Checker enabled! \n");
    DPRINTF("      Now press different buttons to verify functionality... \n");
    DPRINTF("      Reset device to disable this feature. \n");
  ...
  switch (btnEvent)
  {
    case EVENT_PB1_DOWN:            DPRINTF("    BTN0 DOWN \n"); break;
    case EVENT_PB2_DOWN:            DPRINTF("    BTN1 DOWN \n"); break;
    case EVENT_PB3_DOWN:            DPRINTF("    BTN2 DOWN \n"); break;
    case EVENT_PB4_DOWN:            DPRINTF("    BTN3 DOWN \n"); break;
    case EVENT_PB5_DOWN:            DPRINTF("    BTN4 DOWN \n"); break;
    case EVENT_PB6_DOWN:            DPRINTF("    BTN5 DOWN \n"); break;
    case EVENT_SLIDER1_DOWN:        DPRINTF("    SLIDER1 DOWN \n"); break;

    case EVENT_PB1_UP:              DPRINTF("    BTN0 UP \n"); break;
    case EVENT_PB2_UP:              DPRINTF("    BTN1 UP \n"); break;
    case EVENT_PB3_UP:              DPRINTF("    BTN2 UP \n"); break;
    case EVENT_PB4_UP:              DPRINTF("    BTN3 UP \n"); break;
    case EVENT_PB5_UP:              DPRINTF("    BTN4 UP \n"); break;
    case EVENT_PB6_UP:              DPRINTF("    BTN5 UP \n"); break;
    case EVENT_SLIDER1_UP:          DPRINTF("    SLIDER1 UP \n"); break;

    case EVENT_PB1_SHORT_PRESS:     DPRINTF("    BTN0 SHORT PRESS \n"); break;
    case EVENT_PB2_SHORT_PRESS:     DPRINTF("    BTN1 SHORT PRESS \n"); break;
    case EVENT_PB3_SHORT_PRESS:     DPRINTF("    BTN2 SHORT PRESS \n"); break;
    case EVENT_PB4_SHORT_PRESS:     DPRINTF("    BTN3 SHORT PRESS \n"); break;
    case EVENT_PB5_SHORT_PRESS:     DPRINTF("    BTN4 SHORT PRESS \n"); break;
    case EVENT_PB6_SHORT_PRESS:     DPRINTF("    BTN5 SHORT PRESS \n"); break;
    case EVENT_SLIDER1_SHORT_PRESS: DPRINTF("    SLIDER1 SHORT PRESS \n"); break;

    case EVENT_PB1_HOLD:            DPRINTF("    BTN0 HOLD \n");
      checkLEDsOnEXPBoard();
      break;
    case EVENT_PB2_HOLD:            DPRINTF("    BTN1 HOLD \n"); break;
    case EVENT_PB3_HOLD:            DPRINTF("    BTN2 HOLD \n"); break;
    case EVENT_PB4_HOLD:            DPRINTF("    BTN3 HOLD \n"); break;
    case EVENT_PB5_HOLD:            DPRINTF("    BTN4 HOLD \n"); break;
    case EVENT_PB6_HOLD:            DPRINTF("    BTN5 HOLD \n"); break;
    case EVENT_SLIDER1_HOLD:        DPRINTF("    SLIDER1 HOLD \n"); break;

    case EVENT_PB1_LONG_PRESS:      DPRINTF("    BTN0 LONG PRESS \n"); break;
    case EVENT_PB2_LONG_PRESS:      DPRINTF("    BTN1 LONG PRESS \n"); break;
    case EVENT_PB3_LONG_PRESS:      DPRINTF("    BTN2 LONG PRESS \n"); break;
    case EVENT_PB4_LONG_PRESS:      DPRINTF("    BTN3 LONG PRESS \n"); break;
    case EVENT_PB5_LONG_PRESS:      DPRINTF("    BTN4 LONG PRESS \n"); break;
    case EVENT_PB6_LONG_PRESS:      DPRINTF("    BTN5 LONG PRESS \n"); break;
    case EVENT_SLIDER1_LONG_PRESS:  DPRINTF("    SLIDER1 LONG PRESS \n"); break;
